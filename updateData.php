  ...
  else
  {
    ...
    else
    {
      ...
      if($phone)
      {
        if($new)
        {
          $select = "select PhoneNumber from account where Email='".$new."'";
        }
        else {
          $select = "select PhoneNumber from account where Email='".$current."'";
        }
        ...
        $update = "Update account Set PhoneNumber='\"$phone\"' Where PhoneNumber = '\"$userNum\";'";
        $update2 = "Update receipt Set PhoneNumber='\"$phone\"' Where PhoneNumber = '\"$userNum\";'";
        //echo $update.$update2;
        if($conn->query($update)&&$conn->query($update2))
        {
